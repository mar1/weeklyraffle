...
const raffle1Price = '3.77 GLMR'
const raffle2Winners = []
const raffle2Rounds = 3
const raffle2Price = '9.44 GLMR'
const raffle3Winner = []
const raffle3Price = '23.6 GLMR'
const raffle4Winner = []
...
async function raffle1() {
    ...
    await sleep(3000)
    console.log(`Raffle 1 winner - ${raffle1Price}:`, `GLMR APE ${winner}`)
...
async function raffle2() {
    ...
    winners.push(winner,wallet) 
    await sleep(3000)
    console.log(`Raffle 2 winner - ${raffle2Price}:`, `GLMR APE ${winner}`)
